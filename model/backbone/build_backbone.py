...
class Backbone(nn.Module):
    ...
    def add_extras(self,model_name,lay,in_channel):
        if model_name == 'resnet50':
            exts1 = nn.Sequential(ConvModule(2048,256,1,normalize=None,stride = 1,bias=True,inplace=False),
                    ConvModule(256,512,3,normalize=None,stride = 2,padding = 1,bias=True,inplace=False)
